            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">{{'Per/Km charge'}}</a></li>
                    <li class="breadcrumb-item active">{{'Per/Km charge'}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
...
<div id="modalcourier" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form method="POST" action="{{route('addPerkmPrice')}}">
        {{csrf_field()}}
      <div class="modal-header" style="background: dodgerblue;">
           <h4 class="modal-title" style="color:white;">Add Per/Km charge</h4>
