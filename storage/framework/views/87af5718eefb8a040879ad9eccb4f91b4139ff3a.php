...
<?php endif; ?>
	 ...
	 <li class="nav-item has-treeview ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('basePrice')); ?>">
                            <i class="nav-icon fa fa-circle-o"></i><p>Base Price</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('PerkmPrice')); ?>">
                            <i class="nav-icon fa fa-circle-o"></i><p>Per Km Charge</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('fragilePrice')); ?>">
                            <i class="nav-icon fa fa-circle-o"></i> <p>Fragile Charge</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('indexCourier')); ?>">
                            <i class="nav-icon fa fa-circle-o"></i><p>Courier Type Charge</p>
                        </a>
                    </li>
					<li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('courierMode')); ?>">
                            <i class="nav-icon fa fa-circle-o"></i><p>Courier Mode Charge</p>
                        </a>
                    </li>
					
					<li class="nav-item">
                        <a class="nav-link " href="<?php echo e(route('ordersList')); ?>">
...
<?php /**PATH /home/gadgetekbahamas/multi-restaurants.gadgetekbahamas.com/resources/views/layouts/menu.blade.php ENDPATH**/ ?>