...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.faq_category_plural')); ?> <small><?php echo e(trans('lang.faq_category_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fa fa-list mr-2"></i><?php echo e(trans('lang.faq_category_table')); ?></a>
        </li>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faqCategories.create')): ?>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('faqCategories.create'); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('lang.faq_category_create')); ?></a>
        </li>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-restaurants\resources\views/faq_categories/index.blade.php ENDPATH**/ ?>