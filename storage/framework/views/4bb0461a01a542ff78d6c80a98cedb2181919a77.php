...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('settings_title',trans('lang.permission_edit')); ?>
    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo route('permissions.edit',$permission->id); ?>"><i class="fa fa-pencil mr-2"></i><?php echo e(trans('lang.permission_edit')); ?></a>
                </li>
                <li class="nav-item">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.settings.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-restaurants\resources\views/settings/permissions/edit.blade.php ENDPATH**/ ?>